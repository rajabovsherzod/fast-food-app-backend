...
router.patch(
  "/orders/:id/status",
  validate(adminValidator.updateOrderStatusSchema),
  adminController.updateOrderStatus
);
router.patch(
  "/orders/:id/assign-delivery",
  validate(adminValidator.assignDeliverySchema),
...
router.post(
  "/foods",
  validate(adminValidator.createFoodSchema),
  adminController.createFood
);
router.put(
  "/foods/:id",
  validate(adminValidator.updateFoodSchema),
  adminController.updateFood
);
router.delete("/foods/:id", adminController.deleteFood);
router.patch(
  "/foods/:id/availability",
  validate(adminValidator.toggleFoodAvailabilitySchema),
...
router.post(
  "/categories",
  validate(adminValidator.createCategorySchema),
  adminController.createCategory
);
router.put(
  "/categories/:id",
  validate(adminValidator.updateCategorySchema),
